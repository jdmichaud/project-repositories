...
** 
** Started on  Sun Jan  6 16:16:51 2002 GIZMO
** Last update Thu Jan 10 14:37:31 2002 GIZMO
*/
...
/*
** ld rx, [ry]
** load : Charge les P + 1 quartets stockés à l'adresse PC + (ry % IDX_MOD)
** dans les quartets 0 à P de rx. ry est signé et utilisé en entier.
